...
import { editPhoto, deletePhoto, getPhoto } from "../../../core/services/photo.service";
...
function EditPhoto() {
  ...
  useEffect(() => {
    getPhoto(id).then(data => {
      setPhoto(data.photo);
      setImagePreview(data.photo.imgUrl);
    })
  ...
  return (
    ...
    <form className="editPhoto" onSubmit={editHandler}>
      <div className="row default_center">
        <div className="col medium_8">
          <div className="row default_center">
            <div className="col">
              
              <h1 className="section_title text_center">Edit photo</h1>
            ...
            <div className="col">
              <div className="input_wrapper required ">
                ...
                <input type="text" placeholder="Enter Title" name="title" required value={photo.title} onInput={onInputChange} />
            ...
            <div className="col">
              <div className="input_wrapper">
                ...
                <textarea placeholder="Enter Description" name="description" rows="5" value={photo.description} onInput={onInputChange}></textarea>
                    ...
                    categories.map((category, i) => 
                      <div className="col large_4" key={category._id}>
                        <input 
                          ...
                          id={category._id}
                          checked={photo.categories?.find(cat => cat._id == category._id)}
                          value={category._id}
